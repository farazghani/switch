        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 pt-8 border-t border-border/20">
            <div className="text-center space-y-2">
              ...
              <div className="text-sm text-muted-foreground">Be among the first to try Switch</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-lg font-semibold text-primary">Exclusive Features</div>
              <div className="text-sm text-muted-foreground">Get access to beta features first</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-lg font-semibold text-primary">Special Pricing</div>
              <div className="text-sm text-muted-foreground">Early bird discounts and offers</div>
            </div>
          </div>
        </div>
      </div>
